...
#define START_DISCOVERY_DEVICE_EVT					 	0x0004
#define CONNECT_NEXT_DEVICE_EVENT 						0x0008
...
#if LSQ_DBG == TRUE
#define LSQ_PrintString(str)			NPI_PrintString((str))
#define LSQ_PrintValue(str,val,line)	NPI_PrintValue((str),(val),(line))
#else
#define LSQ_PrintString(str)			
#define LSQ_PrintValue(str,val,line)	
#endif
