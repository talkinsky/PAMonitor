...
#define HAL_KEY_SW_1_IEN      P1IEN  /* CPU interrupt mask register */
#define HAL_KEY_SW_1_IENBIT   BV(7) /* Mask bit for all of Port_1 */
#define HAL_KEY_SW_1_ICTL     PICTL /* Port Interrupt Control register */
#define HAL_KEY_SW_1_ICTLBIT  BV(2) /* P1IEN - P1.7 enable/disable bit */
...
#define HAL_KEY_SW_2_IEN      P1IEN  /* CPU interrupt mask register */
#define HAL_KEY_SW_2_IENBIT   BV(6) /* Mask bit for all of Port_0 */
#define HAL_KEY_SW_2_ICTL     PICTL /* Port Interrupt Control register */
#define HAL_KEY_SW_2_ICTLBIT  BV(2) /* P1IEN - P1.6 enable/disable bit */
