...
///////////////////////////////////////////LED Setting change by LSQ 20170310/////////////////////
/* LED Configuration */
...
/* 2 - Alarm status */
#define ALARM_LED_BV                      LED2_BV
#define ALARM_LED_SBIT                    LED2_SBIT 
#define ALARM_LED_DDR                     LED2_DDR
...
#define POWER_5V_DDR                     P0DIR
#define POWER_5V_POLARITY                ACTIVE_HIGH


#define POWER_24V_BV                      BV(3)
#define POWER_24V_SBIT                    P0_3
...
#define DISP_INT_DDR                     P0DIR
#define DISP_INT_POLARITY                ACTIVE_HIGH

#define DISP_RST_BV                      BV(6)
#define DISP_RST_SBIT                    P0_6
#define DISP_RST_DDR                     P0DIR
#define DISP_RST_POLARITY                ACTIVE_HIGH

#define DISP_RSTI_BV                      BV(7)
#define DISP_RSTI_SBIT                    P0_7
