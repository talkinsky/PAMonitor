...
/*
 * Initialize Dig Board Service.
 */
extern void HalDigInit( void );

/*
 * Set the Dig Board Blink Mode.
 */
extern uint8 HalDigFlash( uint8 enable );
 ...
 */
extern void HalDigEnterSleep( void );

/*
 * Retore Dig Board from sleep state
 */
extern void HalDigExitSleep( void );
