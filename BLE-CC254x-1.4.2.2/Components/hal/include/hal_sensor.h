...
#define HAL_SENSOR_POWER_5V      0x01
#define HAL_SENSOR_POWER_24V     0x02
#define HAL_SENSOR_POWER_ALL   (HAL_SENSOR_POWER_5V | HAL_SENSOR_POWER_24V)

/* Modes */
#define HAL_SENSOR_POWER_OFF     0x00
#define HAL_SENSOR_POWER_ON      0x01
 ...
 */
extern void HalSensorInit( void );

/*
 * Enable/disable Sensor Service.
 */
extern void HalSensorEnable( uint8 enable );


/*
 * Start the sensor calibration.
 */
extern uint8 HalSensorCalibration( void );
